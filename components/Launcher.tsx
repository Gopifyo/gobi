                    ...
                    <div className="text-center space-y-6 md:space-y-8">
                        <h2 className="text-3xl sm:text-5xl md:text-7xl font-light tracking-tighter leading-[1.05] text-white drop-shadow-2xl px-2 max-w-4xl mx-auto">
                            <span className="text-xl sm:text-2xl md:text-4xl text-zinc-400 font-thin mt-4 block">
                                <DecryptedText text="— connecting wet lab science and software." delay={500} />
                            </span>
                        </h2>
                        
                        <div className="flex flex-wrap items-center justify-center gap-3 pt-4 animate-in fade-in slide-in-from-bottom-2 duration-1000">
                            <div className="px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-[10px] md:text-xs font-mono uppercase tracking-[0.2em] shadow-[0_0_15px_rgba(16,185,129,0.1)]">Biotech</div>
                            <div className="px-4 py-2 rounded-full border border-sky-400/30 bg-sky-400/10 text-sky-400 text-[10px] md:text-xs font-mono uppercase tracking-[0.2em] shadow-[0_0_15px_rgba(56,189,248,0.1)]">Consumer Products</div>
                            <div className="px-4 py-2 rounded-full border border-violet-400/30 bg-violet-400/10 text-violet-400 text-[10px] md:text-xs font-mono uppercase tracking-[0.2em] shadow-[0_0_15px_rgba(167,139,250,0.1)]">AI Automation</div>
                        </div>
