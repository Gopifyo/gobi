...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900 font-sans selection:bg-neutral-200/50 pb-32 relative">
      ...
      {/* Content Stack */}
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-12 space-y-32 md:space-y-48 pt-20 md:pt-40 overflow-hidden w-full">
        ...
        <section id="experience" className="scroll-mt-32">
          <SectionHeader title="Experience" subtitle="Where I have worked." />
          <ExperienceSection />
        </section>

        {/* Section: Projects & Portfolio */}
        <section id="projects" className="scroll-mt-32">
          <SectionHeader title="Projects" subtitle="Projects & Open Source" />
          <ProjectsSection />
        </section>

        {/* Section: Skills */}
        <section id="skills" className="scroll-mt-32">
          <SectionHeader title="Skills" subtitle="Core capabilities." />
          <SkillsSection />
        </section>
        ...
        <section id="education" className="scroll-mt-32">
          ...
          <div className="mt-32 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div>
               <SectionHeader title="Gallery" subtitle="Lab and project documentation." />
               <GallerySection />
            </div>
          </div>
        </section>
